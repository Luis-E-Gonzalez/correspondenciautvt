...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header bg-success text-light" style="text-align: center;">
            ...
            <h2> <a href="{{route('reporte_actividades')}}" class="btn  btn-success btn-dual" type="button"><i class="fas fa-arrow-left"></i> Regresar</a>
                &nbsp;&nbsp;
                Gesti&oacute;n de actividades</h2>
        </div>
        <div class="card-body">
            <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fechacreacion"
                                                name="fechacreacion" value="{{ $hoy }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tipodetalle" name="tipodetalle"
                                                value="{{ $user[0]->tipo_usuario . ' - ' . $user[0]->nombre_areas }}"
                                                readonly>
