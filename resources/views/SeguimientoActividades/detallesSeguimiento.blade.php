...
<div class="card">
  ...
  <div class="modal fade" id="ajaxModel" value="1" aria-hidden="true">
    ...
    //crear modal para la visualizacion de archivos de los seguimientos
      $('body').on('click', '.DetallesArchivos', function() {
        //variable que recupera el id de las actividades
        var id = $(this).data('id');
        //variable de control
        var i = 0;
        $.get("../DetallesArchivos/" + id, function(data) {
          //eliminamos modales que puedan interferir
          $('#tablaModal>tbody>tr').remove();
          //for que busca todos los archivos relacionados con el id del seguimiento de la actividad
          for (i = 0; i <= data.length - 1; i++) {
            //muestra el modal
            $('#ajaxModel').modal('show');
            //variables que recuperan el nombre y los detalles de los archivos
            ...
            //variable que crea el enlace de descarga
            ...
            //crea la tabla para mostrar los archivos del seguimiento
